...
import { d as dateTime } from "../../chunks/utils.js";
const app = "";
const stores = {};
...
const css = {
  code: "section.svelte-1kr8pfx,.clockWrapper.svelte-1kr8pfx,.clockDisplay.svelte-1kr8pfx{display:flex;justify-content:right;align-items:right}section.svelte-1kr8pfx{width:100%;overflow:hidden}.clockWrapper.svelte-1kr8pfx{width:80%;height:50%;border-radius:15px}.clockDisplay.svelte-1kr8pfx{width:99%;height:99%;font-size:1em}",
  map: null
};
const Clock = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let date = /* @__PURE__ */ new Date();
  let showDateTime = dateTime(date.toString());
  $$result.css.add(css);
  return `<section class="svelte-1kr8pfx"><div id="" class="clockWrapper svelte-1kr8pfx"><p class="clockDisplay text-gray-800 dark:text-gray-200 svelte-1kr8pfx">${escape(showDateTime)}</p></div> </section>`;
});
  ...
  return ` ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    footer: () => {
      return ` ${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
        trail: () => {
          return `${validate_component(Clock, "Clock").$$render($$result, {}, {}, {})}`;
        }
      })} `;
    },
    header: () => {
      return ` ${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
        ...
        lead: () => {
          return ` <h1 class="h1 uppercase gradient-heading" data-svelte-h="svelte-1p4ud4k">Smart Farming</h1>`;
        }
      })} `;
    },
    default: () => {
